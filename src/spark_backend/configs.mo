module{
    public let IC_ID = "aaaaa-aa";
    public let CMC_ID = "rkp4c-7iaaa-aaaaa-aaaca-cai";
    public let SPARK_MAIN_ID = "bd3sg-teaaa-aaaaa-qaaba-cai";
    public let SPARK_PORTAL_ID = "bkyz2-fmaaa-aaaaa-qaaaq-cai";
